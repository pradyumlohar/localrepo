...
public class TestAcititimeLogin2 extends SeleniumUtility {
	...
	public void i_entered_user_name_as(String username) {
	...
	@Then("^I should navigate to Acititime home with title (.+)$")
	public void i_should_navigate_to_acititime_home_with_title(String pagetitle) {
		String actualHomePageUrl = getCurrentTitleOfApplication(pagetitle);
		Assert.assertEquals(actualHomePageUrl, pagetitle, "Actitime login failed or title changed");
